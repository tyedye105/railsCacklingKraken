...
describe "add product path" do
  it "will let the user at a product to the inventory" do
    ...
    click_link 'Edit'
    fill_in "Name", :with => "The Not Cursed Box"
    fill_in "Description", :with => "It's not cursed"
    fill_in "Found in", :with => "Steve's Uncle's Backyard"
    fill_in "Going price", :with => "244"
    click_button 'Update Product'
    expect(page).to have_content 'The Not'
